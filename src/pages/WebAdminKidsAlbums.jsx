...
import { 
  ...
  FaUnderline, FaListUl, FaListOl, FaAlignLeft, FaAlignCenter, 
  FaAlignRight, FaLink, FaImage, FaCaretDown, FaSearch
} from 'react-icons/fa';
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-6 overflow-hidden">
        ...
        <div className="p-6">
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="w-full lg:w-1/3">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 flex flex-col items-center justify-center h-[280px] bg-white relative">
                ...
                <div className="text-[11px] text-gray-400 mt-1">JPG • PNG • JPEG | Max 1MB</div>
                <div className="text-[10px] text-gray-400 mt-2">No spaces in filename</div>
              </div>
            </div>
          ...
          <div className="flex justify-end items-center gap-4 mt-8 pt-4">
            ...
            <button className="bg-[#6db54a] hover:bg-[#5da23c] text-white text-sm font-medium py-2 px-4 rounded transition">Save & Add SubAlbum</button>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden mb-8">
        <div className="bg-[#f8f9fb] px-5 py-4 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-bold text-gray-800">All Kids Albums <span className="text-xs font-normal text-gray-500 bg-gray-100 px-1.5 py-0.5 rounded">(0 total)</span></h2>
          </div>
          ...
          <div className="flex items-center">
            <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden bg-white">
              <div className="relative border-r border-gray-200">
                ...
                <input type="text" placeholder="Search albums by title, session, or status..." className="w-64 px-3 py-2 pl-8 text-xs text-gray-600 outline-none" />
              </div>
        ...
        <div className="p-4 border-b border-gray-100 text-[11px] font-semibold text-[#6db54a] flex items-center gap-2">
          <FaListUl /> Showing all 1 entries (DataTable unavailable)
        </div>
          ...
          <table className="w-full text-sm text-left">
            <thead className="text-[11px] text-gray-600 uppercase bg-gray-50/50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-4 py-3 font-semibold text-center">ADD SUBALBUM</th>
              ...
              <tr>
                <td colSpan="7" className="px-4 py-8 text-center text-gray-500 text-sm">
                  <div className="flex items-center justify-center gap-2">
                    <FaImages className="text-gray-400" /> No albums found
                  </div>
                </td>
              </tr>
            </tbody>
