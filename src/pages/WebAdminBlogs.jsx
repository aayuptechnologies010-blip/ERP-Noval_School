...
import { 
  ...
  FaUnderline, FaListOl, FaQuoteRight, FaAlignLeft, FaAlignCenter, 
  FaAlignRight, FaAlignJustify, FaLink, FaImage, FaCaretDown
} from 'react-icons/fa';
          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              ...
              <div className="border border-gray-300 rounded overflow-hidden">
                ...
                <textarea rows="12" className="w-full p-3 text-sm outline-none resize-y"></textarea>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <div className="flex-1">
                ...
                <div className="flex items-center border border-gray-300 rounded overflow-hidden">
                  <button className="bg-gray-100 hover:bg-gray-200 border-r border-gray-300 px-3 py-1.5 text-xs text-gray-700 font-medium">Choose File</button>
                  <span className="px-3 py-1.5 text-xs text-gray-500">No file chosen</span>
                </div>
              </div>
              <div className="flex-1">
              ...
              <div className="flex-1 flex flex-col justify-start">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {status && <span className="bg-white text-gray-700 text-xs font-medium">Active</span>}
                </div>
              </div>
            </div>
        ...
        <div className="bg-[#f8f9fb] px-5 py-4 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              <input type="text" placeholder="Search blogs..." className="w-64 border border-gray-300 rounded px-3 py-1.5 pl-3 text-xs text-gray-600 outline-none focus:border-blue-500" />
            </div>
