...
import { 
  FaRegClock, FaArrowsAltV, FaBullhorn
} from 'react-icons/fa';

export default function WebAdminLFDNoticeDisplayTime() {
  return (
    <div className="flex-1 overflow-y-auto p-6 bg-[#f4f5f7]">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-xl font-bold text-[#1f2937]">LFD Notice Display Configuration</h1>
        <div className="text-xs text-gray-500 font-medium">
          Home <span className="mx-1">&gt;</span> Website <span className="mx-1">&gt;</span> LFD <span className="mx-1">&gt;</span> Notice Display Time
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden mb-8">
        <div className="bg-white px-5 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-bold text-gray-800">Notice Display Configuration</h2>
          </div>
        ...
        <div className="px-5 pb-4">
          <div className="bg-[#e6f4ff] border border-[#91d5ff] rounded p-3 flex items-start gap-2 mb-4">
            <FaBullhorn className="text-[#1890ff] mt-0.5 text-xs" />
            <p className="text-xs text-[#0050b3]"><span className="font-semibold">Notice Display Configuration:</span> Set the display order (1-1000) and time duration (1-1200 seconds) for each notice on the LFD screen. Lower order numbers display first.</p>
          </div>
          ...
          <div className="flex justify-between items-center mt-6">
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 px-3 py-1.5 rounded text-[11px] text-gray-600">
                <FaArrowsAltV className="text-blue-500" /> Order: 1-1000 (Unique)
              </div>
              <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 px-3 py-1.5 rounded text-[11px] text-gray-600">
                <FaRegClock className="text-green-500" /> Time: 1-1200 seconds
              </div>
              <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 px-3 py-1.5 rounded text-[11px] text-gray-600">
                <FaBullhorn className="text-blue-500" /> Only active notices will be shown
              </div>
            </div>
