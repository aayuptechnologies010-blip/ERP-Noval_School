...
import { 
  FaTrophy, FaCalendarAlt, FaCloudUploadAlt, FaListUl, FaSearch
} from 'react-icons/fa';
        ...
        <div className="p-6">
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1 flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex-1">
                  ...
                  <input type="text" placeholder="Enter Achievement Title" className="w-full border border-gray-300 rounded px-3 py-2 text-sm text-gray-600 outline-none focus:border-blue-500" />
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1">
                  ...
                  <input type="text" placeholder="Enter Venue" className="w-full border border-gray-300 rounded px-3 py-2 text-sm text-gray-600 outline-none focus:border-blue-500" />
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex-1">
                  <label className="block text-xs font-medium text-gray-700 mb-1">Show On</label>
                  <input type="text" defaultValue="Website" className="w-full border border-gray-300 rounded px-3 py-2 text-sm text-gray-600 outline-none focus:border-blue-500" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="border border-gray-300 rounded overflow-hidden">
                  <textarea rows="5" placeholder="Enter Description" className="w-full p-3 text-sm text-gray-600 outline-none resize-y"></textarea>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/3">
              <label className="block text-xs font-medium text-gray-700 mb-1">Attach Image <span className="text-red-500">*</span></label>
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 flex flex-col items-center justify-center h-[280px] bg-white relative">
                <span className="absolute top-3 left-3 bg-blue-600 text-white text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">IMAGE</span>
                ...
                <div className="text-[11px] text-gray-400 mt-1">JPG • JPEG • PNG | Max 1MB</div>
              </div>
            </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden mb-8">
        <div className="bg-[#f8f9fb] px-5 py-4 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-bold text-gray-800">All Achievements</h2>
          </div>
          ...
          <table className="w-full text-sm text-left">
            <thead className="text-[11px] text-gray-600 uppercase bg-gray-50/50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-4 py-3 font-semibold text-center">VENUE</th>
