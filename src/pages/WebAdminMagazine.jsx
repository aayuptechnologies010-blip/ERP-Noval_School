...
import { 
  FaBookOpen, FaCalendarAlt, FaCloudUploadAlt, FaListUl
} from 'react-icons/fa';
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-6 overflow-hidden">
        ...
        <div className="p-6">
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1 flex flex-col gap-6">
              ...
              <div>
                ...
                <input type="text" placeholder="Enter Magazine Name" className="w-full border border-gray-300 rounded px-3 py-2 text-sm text-gray-600 outline-none focus:border-blue-500" />
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button className="w-9 h-9 flex items-center justify-center text-gray-600 hover:text-gray-800 transition text-lg font-light">+</button>
                  </div>
                </div>
            ...
            <div className="w-full lg:w-[400px]">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center bg-white relative h-[180px]">
                ...
                <div className="text-[10px] text-gray-400 mt-1">PDF Only | Max 250MB</div>
          ...
          <div className="flex justify-end items-center gap-4 mt-8 pt-4">
            ...
            <button className="bg-[#009efb] hover:bg-[#008de0] text-white text-sm font-medium py-2 px-6 rounded transition shadow-sm">Save & Continue</button>
          </div>
        </div>
      </div>
          ...
          <table className="w-full text-sm text-left">
            <thead className="text-[11px] text-gray-600 uppercase bg-gray-50/50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-4 py-3 font-semibold text-center">UPDATED DATE</th>
                <th className="px-4 py-3 font-semibold text-center">FILE SIZE</th>
                <th className="px-4 py-3 font-semibold text-center">STATUS</th>
                <th className="px-4 py-3 font-semibold text-center">VIEW PAGES</th>
