...
import { Search, XCircle, Undo2 } from 'lucide-react';
        ...
        <div style={{ display: 'flex', gap: '15px' }}>
          <div style={{ flex: 1 }}>
            ...
            <select style={{ width: '100%', padding: '8px', border: '1px solid #d1d5db', borderRadius: '4px', outline: 'none', fontSize: '12px' }}>
              <option>Select Installm...</option>
            </select>
          </div>
          <div style={{ flex: 1 }}>
            <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', marginBottom: '6px', color: '#374151' }}>Refund Date</label>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '10px', fontSize: '11px' }}>
          <thead>
            <tr style={{ borderBottom: '1px solid #e5e7eb' }}>
              ...
              <th style={{ padding: '8px', textAlign: 'left', color: '#374151' }}>Last Refund Amt.</th>
              <th style={{ padding: '8px', textAlign: 'left', color: '#374151' }}>Refundable Amt.</th>
              <th style={{ padding: '8px', textAlign: 'left', color: '#374151' }}>Refund Amt.</th>
            </tr>
          </thead>
          <tbody>
          </tbody>
