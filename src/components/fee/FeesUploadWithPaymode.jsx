      ...
      <div style={{ marginTop: '30px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '10px' }}>
          ...
          <div style={{ display: 'flex', gap: '20px' }}>
            ...
            <a href="#" style={{ fontSize: '12px', color: '#29a9d8', textDecoration: 'none' }}>Download Data</a>
          </div>
        </div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '11px' }}>
          ...
          <tbody>
            <tr>
              <td colSpan="14" style={{ padding: '15px', textAlign: 'center', color: '#6b7280', background: '#f3f4f6', border: '1px solid #e5e7eb' }}>
                No records found.
              </td>
            </tr>
          </tbody>
