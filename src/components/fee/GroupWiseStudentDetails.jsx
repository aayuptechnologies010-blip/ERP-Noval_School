  ...
  return (
    <div style={{ display: 'flex', height: '100%', background: '#f3f4f6' }}>
      ...
      <div style={{ width: '250px', background: '#fff', borderRight: '1px solid #e5e7eb', padding: '20px', display: 'flex', flexDirection: 'column', gap: '20px', flexShrink: 0, overflowY: 'auto' }}>
        ...
        <div>
          <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', marginBottom: '6px', color: '#374151' }}>Group</label>
          <select style={{ width: '100%', padding: '8px', border: '1px solid #d1d5db', borderRadius: '4px', fontSize: '12px', outline: 'none' }}>
            <option>All Fee Group(s)</option>
          </select>
        </div>

        <div style={{ display: 'flex', gap: '15px', fontSize: '12px', color: '#374151' }}>
          <label style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <input type="radio" name="displayType" defaultChecked /> Consolidated
          </label>
          <label style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <input type="radio" name="displayType" /> Separated
          </label>
        </div>
        ...
        <div style={{ display: 'flex', gap: '15px', fontSize: '12px', color: '#374151', flexWrap: 'wrap' }}>
          <label style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <input type="radio" name="wiseType" defaultChecked /> Installment Wise
          </label>
          <label style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <input type="radio" name="wiseType" /> Head Wise
          </label>
          <label style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <input type="radio" name="wiseType" /> All
          </label>
        </div>
