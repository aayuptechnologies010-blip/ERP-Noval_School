    ...
    <div style={{ display: 'flex', gap: '20px', padding: '20px', background: '#fff', minHeight: '100%' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <div style={{ display: 'flex', gap: '15px', alignItems: 'flex-end' }}>
          ...
          <button style={{ background: '#29a9d8', color: '#fff', border: 'none', padding: '8px 16px', borderRadius: '4px', fontSize: '12px', display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer', height: '33px' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '10px', fontSize: '11px' }}>
          ...
          <tbody>
            <tr>
              <td style={{ padding: '8px', fontWeight: 'bold', color: '#374151', borderTop: '1px solid #e5e7eb' }}>Total</td>
              <td style={{ padding: '8px', fontWeight: 'bold', color: '#374151', borderTop: '1px solid #e5e7eb' }}>0.00</td>
            </tr>
          </tbody>
        </table>
