...
export default function UploadedExcelDetails() {
  return (
      ...
      <div style={{ width: '250px', background: '#fff', borderRight: '1px solid #e5e7eb', padding: '20px', display: 'flex', flexDirection: 'column', gap: '20px', flexShrink: 0, overflowY: 'auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <input type="radio" id="classWise" name="excelType" defaultChecked style={{ cursor: 'pointer' }} />
            <label htmlFor="classWise" style={{ fontSize: '11px', color: '#374151', cursor: 'pointer' }}>Class wise</label>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <input type="radio" id="excelSheetWise" name="excelType" style={{ cursor: 'pointer' }} />
            <label htmlFor="excelSheetWise" style={{ fontSize: '11px', color: '#374151', cursor: 'pointer' }}>Excel Sheet Wise</label>
          </div>
        </div>

        <div>
          <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', marginBottom: '6px', color: '#374151' }}>Standard</label>
          <select style={{ width: '100%', padding: '8px', border: '1px solid #d1d5db', borderRadius: '4px', fontSize: '12px', outline: 'none' }}>
        ...
        <div>
          <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', marginBottom: '6px', color: '#374151' }}>Fee Status</label>
          <select style={{ width: '100%', padding: '8px', border: '1px solid #d1d5db', borderRadius: '4px', fontSize: '12px', outline: 'none' }}>
            <option>Select All</option>
          </select>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <input type="checkbox" id="dateRange" style={{ cursor: 'pointer' }} />
          <label htmlFor="dateRange" style={{ fontSize: '11px', fontWeight: 'bold', color: '#374151', cursor: 'pointer' }}>Date Range</label>
        </div>
