      ...
      <div style={{ padding: '30px', maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '30px', marginBottom: '40px' }}>
          <label style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
            <input type="radio" name="salaryGenStatus" defaultChecked /> Both
          </label>
          <label style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
            <input type="radio" name="salaryGenStatus" /> Salary Generated
          </label>
          <label style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
            <input type="radio" name="salaryGenStatus" /> Salary Not Generated
          </label>
        </div>
