  ...
  return (
    <div style={{ display: 'flex', height: '100%', backgroundColor: '#f0f2f5' }}>
      <div style={{ width: '300px', backgroundColor: 'white', padding: '20px', borderRight: '1px solid #ddd', display: 'flex', flexDirection: 'column', gap: '20px', overflowY: 'auto' }}>
        ...
        <div className="form-group">
          <label style={{ fontWeight: 'bold' }}>Salary Cheque</label>
          <select className="settings-input"><option>Select Cheque</option></select>
        </div>

        <div className="form-group">
          <label style={{ fontWeight: 'bold' }}>Salary Format</label>
          <select className="settings-input"><option></option></select>
        </div>

        <button style={{ backgroundColor: '#159BD7', color: 'white', border: 'none', padding: '8px 25px', borderRadius: '4px', display: 'flex', alignItems: 'center', gap: '5px', cursor: 'pointer', width: 'fit-content' }}>
          <Eye size={16} /> Show
        </button>
