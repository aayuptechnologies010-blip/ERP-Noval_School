    ...
    <div style={{ display: 'flex', height: '100%', backgroundColor: '#f0f2f5' }}>
      <div style={{ width: '300px', backgroundColor: 'white', padding: '20px', borderRight: '1px solid #ddd', display: 'flex', flexDirection: 'column', gap: '20px', overflowY: 'auto' }}>
        ...
        <div className="form-group">
          ...
          <select className="settings-input"><option>Select All</option></select>
        </div>

        <div style={{ display: 'flex', alignItems: 'center', gap: '15px', fontSize: '14px' }}>
          <label style={{ display: 'flex', alignItems: 'center', gap: '5px', cursor: 'pointer' }}>
            <input type="radio" name="selectType" defaultChecked /> Single
          </label>
          <label style={{ display: 'flex', alignItems: 'center', gap: '5px', cursor: 'pointer' }}>
            <input type="radio" name="selectType" /> Multiple
          </label>
        </div>

        <div className="form-group">
          <label style={{ fontWeight: 'bold' }}>Employee</label>
          <select className="settings-input"><option>None selected</option></select>
        </div>
        ...
        <div className="form-group">
          <label style={{ fontWeight: 'bold' }}>Head To Show</label>
          <select className="settings-input"><option>All (27)</option></select>
        </div>
