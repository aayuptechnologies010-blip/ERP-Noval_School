  ...
  return (
    <div style={{ display: 'flex', height: '100%', backgroundColor: '#f0f2f5' }}>
      <div style={{ width: '300px', backgroundColor: 'white', padding: '20px', borderRight: '1px solid #ddd', display: 'flex', flexDirection: 'column', gap: '20px', overflowY: 'auto' }}>
        ...
        <div className="form-group">
          <label style={{ fontWeight: 'bold', display: 'block', marginBottom: '5px' }}>Comparison Heads</label>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px', textAlign: 'left', border: '1px solid #ddd' }}>
            <thead>
              <tr style={{ backgroundColor: '#f0f0f0' }}>
                <th style={{ padding: '5px', border: '1px solid #ddd' }}>Heads</th>
            ...
            <tbody>
              <tr>
                <td style={{ padding: '5px', border: '1px solid #ddd', fontWeight: 'bold' }}>Basic</td>
                <td style={{ padding: '5px', border: '1px solid #ddd' }}>
                  <input type="text" defaultValue="0" style={{ width: '100%', border: 'none', textAlign: 'center' }} />
                </td>
        ...
        <div className="form-group">
          <label style={{ display: 'flex', alignItems: 'center', gap: '5px', fontSize: '13px', cursor: 'pointer' }}>
            <input type="checkbox" /> With Salary Group
          </label>
        </div>
