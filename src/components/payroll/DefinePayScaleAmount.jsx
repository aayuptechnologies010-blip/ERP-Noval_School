...
export default function DefinePayScaleAmount() {
  const data = [
    { id: 1, scale: '5300-125-9800', amount: '5300.00', date: '23 Jun 2018' },
    { id: 2, scale: '5300-125-9800', amount: '5400.00', date: '10 Apr 2018' },
    { id: 3, scale: '5300-150-10500', amount: '5200.00', date: '21 Jul 2016' },
  ];
