...
export default function SalaryRange() {
  ...
  return (
    <SummaryCard title="SALARY RANGE WISE NO. OF EMPLOYEES" titleAlign="left">
        ...
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 40 }}>
            ...
            <XAxis 
              ...
              axisLine={true} 
              tickLine={false}
              label={{ value: 'SALARY RANGE', position: 'insideBottom', offset: -20, style: { fontSize: 12, fontWeight: 'bold' } }}
            />
            <YAxis 
              axisLine={true} 
              tickLine={false} 
